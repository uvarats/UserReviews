 ...
 */
final class Version20220304151926 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE review ADD likes LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', ADD dislikes LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
    }
