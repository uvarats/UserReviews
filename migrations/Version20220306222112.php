 ...
 */
final class Version20220306222112 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE review DROP dislikes');
    }
