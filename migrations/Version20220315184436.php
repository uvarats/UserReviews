 ...
 */
final class Version20220315184436 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD avatar_url VARCHAR(100) NOT NULL');
    }
