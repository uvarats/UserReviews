 ...
 */
final class Version20220301202648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tag ADD uses_count INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tag DROP uses_count, CHANGE tag tag VARCHAR(50) NOT NULL COLLATE `utf8mb4_unicode_ci`');
